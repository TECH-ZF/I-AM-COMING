...
(_______)(______)
 ...
 (_)____ (_)     
(_______)(_)     
\033[1;91m<═══\033[1;41m\033[1;97m Created by TECH ZF \033[;0m\033[1;91m═══>\033[1;92m""")
...
def hackmail():
	...
	headers = [('User-agent', 'Mozilla/5.0 (Linux; Android 11; TECNO BD4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Mobile Safari/537.36')]
...
def hackbook():
	...
	headers = {
		'User-Agent':'Mozilla/5.0 (Linux; Android 11; TECNO BD4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Mobile Safari/537.36',
	}
	payload={}
	cookie={}
